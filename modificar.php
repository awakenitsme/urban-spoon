        ...
        <div class="container">
            ...
            <select class="form-control" id="curso" name="curso" required>
                ...
                <optgroup label="Secundaria">
                    <option <?php if($row['Curso']=='1ro de secundaria' ) echo 'selected' ; ?>>1ro de secundaria
                    </option>
                    <option <?php if($row['Curso']=='2do de secundaria' ) echo 'selected' ; ?>>2do de secundaria
                    </option>
                    <option <?php if($row['Curso']=='3ro de secundaria' ) echo 'selected' ; ?>>3ro de secundaria
                    </option>
                    <option <?php if($row['Curso']=='4to de secundaria' ) echo 'selected' ; ?>>4to de secundaria
                    </option>
                    <option <?php if($row['Curso']=='5to de secundaria' ) echo 'selected' ; ?>>5to de secundaria
                    </option>
                    <option <?php if($row['Curso']=='6to de secundaria' ) echo 'selected' ; ?>>6to de secundaria
                    </option>
                </optgroup>
            ...
            <select class="form-control" id="combo" name="combo">
                ...
                <option
                    <?php if($row['Combo']=='1 Croissant relleno de crema de avellana + jugo natural de 16oz' ) echo 'selected' ; ?>>
                    1 Croissant relleno de crema de avellana + jugo natural de 16oz</option>
                <option
                    <?php if($row['Combo']=='1 Croissant relleno de crema de queso + jugo natural de 16oz' ) echo 'selected' ; ?>>
                    1 Croissant relleno de crema de queso + jugo natural de 16oz</option>
                <option
                    <?php if($row['Combo']=='1 Churro relleno de dulce de leche + refresco de 16oz' ) echo 'selected' ; ?>>
                    1 Churro relleno de dulce de leche + refresco de 16oz</option>
                <option
                    <?php if($row['Combo']=='1 Pedazo de pizza con bordes de queso + refresco de 16oz' ) echo 'selected' ; ?>>
                    1 Pedazo de pizza con bordes de queso + refresco de 16oz</option>
            </select>
